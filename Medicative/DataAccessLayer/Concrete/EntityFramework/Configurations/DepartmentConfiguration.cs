...
namespace DataAccessLayer.Concrete.EntityFramework.Configurations
{
    internal class DepartmentConfiguration : IEntityTypeConfiguration<Department>
    {
        public void Configure(EntityTypeBuilder<Department> builder)
        {
            ...
            builder.Property(x => x.SubTitle).IsRequired().HasMaxLength(150).HasColumnType(SqlDbType.NVarChar.ToString());
            builder.Property(x => x.Description).IsRequired().HasMaxLength(1000).HasColumnType(SqlDbType.NVarChar.ToString());
            builder.Property(x => x.RedirectURL).IsRequired().HasMaxLength(300).HasColumnType(SqlDbType.NVarChar.ToString());
